...
<html>
    <head>
        ...
        <script src="js/manage_match.js"></script>
    </head>
    <body>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Manage the Matches</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <table class="table table-hover table-bordered">
                                <thead>
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td><div><button class='glyphicon glyphicon-trash dbtn' style='color:red;'></button><button class='glyphicon glyphicon-pencil ubtn' style='color:blue;margin-left:30px;'></button></div></td>";
