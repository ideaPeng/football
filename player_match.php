...
<html>
    ...
    <body>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                <li><a href="player_home.php"><span class="glyphicon glyphicon-dashboard"></span>View Match</a></li>
                <li class="active"><a href="player_match.php"><span class="glyphicon glyphicon-th"></span>My Match</a></li>
